    ...
    switch (noxStatus) {
      ...
      case 'awaiting_payment':
        return {
          ...
          description: 'Once your client has paid the quote, this module will be unlocked.',
          showStartBtn: false,
          ctaLabel: ''
        };
      case 'paid':
        ...
        <CardContent className="space-y-3 px-4 pb-4">
          <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/50 border border-border/40">
            ...
            <div className="space-y-0.5">
              <p className="text-xs font-medium text-foreground">Contacts Required</p>
              <p className="text-[11px] text-muted-foreground">{frozenMessage}</p>
            </div>
          </div>
      ...
      <CardContent className="space-y-4 px-4 pb-4">
        ...
        {quoteNumber && (
          <div className="text-[10px] text-muted-foreground">
            Quote Ref: <span className="font-mono font-medium">{quoteNumber}</span>
          </div>
        )}
      </CardContent>
    </Card>
