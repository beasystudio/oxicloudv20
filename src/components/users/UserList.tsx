            ...
            <TooltipProvider>
              ...
              return <Tooltip key={user.id}>
                    <TooltipTrigger asChild>
                      <TableRow className="cursor-pointer transition-all duration-200 group hover:backdrop-blur-md hover:shadow-lg hover:shadow-foreground/5 hover:scale-[1.02] hover:z-10" onDoubleClick={() => onEdit(user)}>
