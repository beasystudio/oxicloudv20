        ...
        <CardContent>
          <div className="border rounded-lg overflow-x-auto">
            <Table>
              ...
              <TableBody>
                {statuses.map(status => (
                  <TableRow key={status.id} className="cursor-pointer transition-all duration-200 hover:shadow-md hover:shadow-foreground/20 hover:scale-[1.02] hover:z-10" onDoubleClick={() => handleEdit(status)}>
                    <TableCell>
                      <div 
