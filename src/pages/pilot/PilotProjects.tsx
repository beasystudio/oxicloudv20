        ...
        <CardContent className="pt-6">
          ...
          <ScrollArea className="h-[400px]">
            <div className="space-y-0.5 p-2">
              ...
              return <div key={project.id} className={cn("flex items-center gap-4 px-4 py-3 rounded-lg cursor-pointer transition-all duration-200 group items-start relative", "hover:shadow-md hover:shadow-foreground/20 hover:scale-[1.02] hover:z-10")} onClick={() => handleSelectProject(project.id)}>
