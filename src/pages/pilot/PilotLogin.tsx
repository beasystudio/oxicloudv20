      ...
      <div className="min-h-screen flex bg-secondary">
        ...
        <div className="w-full lg:w-[45%] flex flex-col justify-center px-8 lg:px-16 xl:px-20">
          ...
          >
            ...
            {/* Demo hint */}
            <motion.div variants={item} className="mt-8 p-4 rounded-xl border border-white/8 bg-white/[0.03]">
              <p className="text-sm font-medium text-white/80 mb-1 text-center">
                <span className="inline-block px-2 py-0.5 rounded-full bg-primary/10 text-primary text-xs font-medium mr-2">
                  Demo
                </span>
                Use the credentials you just created
              </p>
              <p className="text-xs text-white/30 text-center">
                Sign in with the email and password from your registration.
              </p>
            </motion.div>
            ...
            <motion.div variants={item} className="mt-8 flex flex-col gap-3">
              <div className="flex items-center justify-center">
                <Link to="/pilot-demo/forgot-password" className="text-xs text-white/40 hover:text-primary transition-colors">
                  Wachtwoord vergeten?
                </Link>
              </div>
              <div className="flex items-center justify-between text-xs text-white/30">
                <Link to="/pilot-demo" className="hover:text-primary transition-colors">
                  Create account
                </Link>
