                ...
                {allContacts.length === 0 ? <div className="flex-1 flex flex-col items-center justify-center py-8 px-4 text-center">
                    ...
                    persons
                          ...
                          {expandedCompanies.has(company) && persons.length > 0 && <div className="bg-background/60 rounded-b-xl mx-0.5">
                              ...
                              <div className="px-4 py-3 ml-6 border-l-2 border-primary/30 dark:bg-transparent bg-muted rounded-xl">
                              ...
                              <div className={cn("px-4 py-3 ml-6 border-l-2 border-primary/30 dark:bg-transparent bg-muted rounded-xl", persons.length > 0 && "border-t border-border/30")}>
                                <div className="flex items-center gap-1.5 text-[9px] font-semibold text-primary uppercase tracking-wider mb-2">
