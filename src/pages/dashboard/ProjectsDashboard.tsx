...
import { ProjectBinderDetail } from '@/components/projects/ProjectBinderDetail';
  ...
  const renderBinderView = () => {
    ...
    return (
      <ProjectBinderDetail
        ...
        companyName={
          isAdmin
            ? selectedProject.companyId === 'gdesign'
              ? 'GDesign Architecten'
              : selectedProject.companyId === '4takt'
                ? '4Takt Architecten'
        ...
        onEditProject={handleProjectFieldDoubleClick}
        onDeleteProject={() => handleDeleteProject(selectedProject.id)}
        onNoxPrimaryAction={handleCTAClick}
        onCloneVersion={handleCloneVersion}
        onContactClick={handleContactClick}
        onContactDoubleClick={handleContactDoubleClick}
        onOpenAddExistingContact={() => setIsAddExistingContactOpen(true)}
        onOpenCreateContact={() => setIsCreateContactOpen(true)}
      />
    );
  };
