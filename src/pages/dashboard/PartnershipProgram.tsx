...
const copy = {
  en: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: 'Once your client has paid, you will receive an email from OxiCloud inviting you to send us your invoice for the partner commission.',
        extra: 'As soon as we receive your invoice, your fee is transferred directly to your bank account.',
        badges: ['Email invitation to invoice OxiCloud'],
      },
    ],
  ...
  nl: {
    ...
    steps: [
      ...
      {
        title: 'Vraag uw commissie aan',
        body: 'Zodra uw klant heeft betaald, ontvangt u een e-mail van OxiCloud met de uitnodiging om uw factuur voor de partnercommissie te bezorgen.',
        extra: 'Zodra wij uw factuur ontvangen, wordt uw vergoeding rechtstreeks op uw bankrekening gestort.',
        badges: ['E-mailuitnodiging om OxiCloud te factureren'],
      },
    ],
