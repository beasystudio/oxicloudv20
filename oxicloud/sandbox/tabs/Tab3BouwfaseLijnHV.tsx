        ...
        <div className="lg:col-span-3 space-y-5">
          ...
          <div className="space-y-1.5">
            <div className="flex items-center justify-between">
              <label className="text-xs font-medium text-foreground">HV trips rate</label>
            ...
            <div className={cn("px-3 py-1.5 rounded-lg text-xs tabular-nums", showAmber ? "bg-amber-500/10 text-amber-600 dark:text-amber-400" : "text-muted-foreground")}>
              Dagelijkse projectritten: <strong>{dailyTrips}</strong>
            </div>
          </div>

          {/* Prefab percentage (synced) */}
          <div className="space-y-1.5">
            <div className="flex items-center justify-between">
            ...
            <p className="text-[10px] text-amber-600 dark:text-amber-400 flex items-start gap-1">
              ...
              Dit percentage beïnvloedt ook de berekeningen voor Bouwfase Puntbronnen en Lijnbron LV.
            </p>
          </div>
